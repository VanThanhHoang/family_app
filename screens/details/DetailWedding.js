    ...
    <View style={{ flex: 1, backgroundColor: "white" }}>
      ...
      <ScrollView style={{ flex: 1, padding: 20 }}>
        ...
        <View style={styles.weddingInfoContainer}>
          ...
          <Text style={styles.weddingInfoText}>Ngày cưới: {data.marriage_date}</Text>
          <Text style={styles.weddingInfoText}>Thời gian kết hôn: {data.marriage_duration}</Text>
          <Text style={styles.weddingInfoText}>Còn {data.days_until_anniversary} ngày đến kỷ niệm ngày cưới</Text>
        </View>
