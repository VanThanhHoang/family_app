...
with_node \
  ...
  --target "/Users/thanh/Documents/mobile_app/familyapp/ios/Pods/Target Support Files/Pods-familyapp/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "@react-native-google-signin/google-signin" "expo-application" "expo-asset" "expo-constants" "expo-crypto" "expo-file-system" "expo-font" "expo-image" "expo-image-manipulator" "expo-image-picker" "expo-keep-awake" "expo-linear-gradient" "expo-media-library" "expo-print" "expo-sharing" "expo-web-browser"
